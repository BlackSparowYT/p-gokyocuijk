        ...
        <main class="contact">
            ...
            <div class="contact-gokyo">
                ...
                <div class="flex-box-1">
                    ...
                    <div class="block-2">
                        <h3>Social Media</h3>
                        <h4>Onze social media's:</h4>
                        <p>
                            We zijn voor nu alleen nog maar te vinden op <strong>Instagram</strong> & <strong>Facebook</strong>
                            <br>
                            Wij hopen om in de toekomst op meer platformen te vinden te zijn! (zoals Twitter?)
                        </p>
                        <br>
                        <br>
                        <br>
